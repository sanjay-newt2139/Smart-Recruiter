...
/**
DMAP TAG: Query needs manual remediation: Identifier30
DMAP ConvertedQuery - null
**/

/**
DMAP TAG: Query needs manual remediation: Identifier29
DMAP ConvertedQuery - null
**/
...
// Open a connection
		try (Connection conn = DriverManager.getConnection(DB_URL1, USER, PASS);
				Statement stmt = conn.createStatement();
/**
DMAP TAG: Query needs manual remediation: Identifier28
DMAP ConvertedQuery - null
**/

/**
DMAP TAG: Query needs manual remediation: Identifier27
DMAP ConvertedQuery - null
**/
...
// Open a connection
		try (Connection conn = DriverManager.getConnection(DB_URL1, USER, PASS);
				Statement stmt = conn.createStatement();
/**
DMAP TAG: Query needs manual remediation: Identifier26
DMAP ConvertedQuery - 
**/

/**
DMAP TAG: Query needs manual remediation: Identifier25
DMAP ConvertedQuery - 
**/
	...
	public void method4() { // DMAP Comment : Dead Code Detected - The Following Method has no reference method4
		...
		try (Connection conn = DriverManager.getConnection(DB_URL1, USER, PASS);
				Statement stmt = conn.createStatement();
/**
DMAP TAG: Query needs manual remediation: Identifier24
DMAP ConvertedQuery - null
**/

/**
DMAP TAG: Query needs manual remediation: Identifier23
DMAP ConvertedQuery - null
**/
	...
	public void method5() { // DMAP Comment : Dead Code Detected - The Following Method has no reference method5
		...
		try (Connection conn = DriverManager.getConnection(DB_URL1, USER, PASS);
				Statement stmt = conn.createStatement();
/**
DMAP TAG: Query needs manual remediation: Identifier22
DMAP ConvertedQuery - null
**/

/**
DMAP TAG: Query needs manual remediation: Identifier21
DMAP ConvertedQuery - null
**/
	...
	public void method6() { // DMAP Comment : Dead Code Detected - The Following Method has no reference method6
		...
		try (Connection conn = DriverManager.getConnection(DB_URL1, USER, PASS);
				Statement stmt = conn.createStatement();
/**
DMAP TAG: Query needs manual remediation: Identifier20
DMAP ConvertedQuery - null
**/

/**
DMAP TAG: Query needs manual remediation: Identifier19
DMAP ConvertedQuery - null
**/
	...
	public void method7() { // DMAP Comment : Dead Code Detected - The Following Method has no reference method7
		...
		try (Connection conn = DriverManager.getConnection(DB_URL1, USER, PASS);
				Statement stmt = conn.createStatement();
/**
DMAP TAG: Query needs manual remediation: Identifier18
DMAP ConvertedQuery - null
**/

/**
DMAP TAG: Query needs manual remediation: Identifier17
DMAP ConvertedQuery - null
**/
