 /* This application remediation was done for embedded Oracle SQL to make it compatible with PostgreSQL with Newt DMAP Version: v1.1.4.3_v8.3.5.2 on Date: 01-Aug-2025 */
import java.sql.*;
import java.utils.*;
